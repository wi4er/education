...
export const TestDbModule = TypeOrmModule.forRoot({
  ...
  entities: [
    Attribute,
    Attribute2String, Attribute2Point, Attribute2AsPoint, Attribute4Status,
    Language,
    Language2String, Language2Point, Language4Status,
    Status,
    Status2String, Status2Point, Status4Status,
    Point,
    Point2String, Point2Point, Point4Status,
    Directory,
    Directory2String, Directory2Point, Directory4Permission, Directory4Status,
    Measure,
    Measure2String, Measure2Point, Measure4Status,
    Group,
    Group2String, Group2Point, Group2Description, Group4Status,
    User,
    User2String, User2Point, User2Description, User2Counter, User4Status,
    User4Group,
    Access,
    Block,
    Block2String, Block2Point, Block2Description, Block2Counter, Block4Status,
    Block4Permission,
    Element,
    Element2String, Element2Point, Element2Description, Element2Counter, Element4Status,
    Element4Section, Element4Permission,
    Section,
    Section2String, Section2Point, Section2Description, Section2Counter, Section4Status,
    Section4Permission,
    Form,
    Form2String, Form2Point, Form2Description, Form2Counter, Form4Status,
    Form4Permission,
    Result,
  ],
  synchronize: true,
