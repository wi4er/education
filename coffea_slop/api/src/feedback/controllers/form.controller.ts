...
import { Form2Permission } from '../entities/form/form2permission.entity';
...
export class FormController {
  ...
  async findAll(): Promise<FormView[]> {
  ...
  async create(
    ...
    const { strings, points, permissions, descriptions, ...formData } = data;
    ...
    const form = await this.dataSource.transaction(async transaction => {
      ...
      await this.permissionAttributeService.create<Form>(transaction, Form2Permission, permissions);
  ...
  async update(
    ...
    const form = await this.dataSource.transaction(async transaction => {
      ...
      await this.permissionAttributeService.update<Form>(transaction, Form2Permission, id, permissions);
